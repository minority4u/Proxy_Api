...
box_content_fields = {
    'id' : fields.Integer,
    'uri': fields.Url('contentressource', absolute=True),
    'name': fields.String,
...
address_fields_full = {
    'id': fields.Integer,
    'uri': fields.Url('addressressource', absolute=True),
    'name': fields.String,
...
box_fields = {
    ...
    'customerStatus' : fields.String,
    'weight': fields.String,
    'size': fields.String,
    'addr_c': fields.Nested(address_fields_full),
    'addr_d': fields.Nested(address_fields_full),
